...
local function constructNew_frmcyberpunk1_svg()
...
function newfrmcyberpunk1_svg()
    local retObj = nil;
    __o_rrpgObjs.beginObjectsLoading();

    __o_Utils.tryFinally(
      function()
        retObj = constructNew_frmcyberpunk1_svg();
      end,
      function()
...
local _frmcyberpunk1_svg = {
    newEditor = newfrmcyberpunk1_svg, 
    new = newfrmcyberpunk1_svg, 
    name = "frmcyberpunk1_svg", 
    dataType = "", 
    formType = "undefined", 
...
frmcyberpunk1_svg = _frmcyberpunk1_svg;
Firecast.registrarForm(_frmcyberpunk1_svg);

return _frmcyberpunk1_svg;
